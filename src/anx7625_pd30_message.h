...
struct message_header {
	/* Message Type*/
	unsigned char message_type:5;
		/* Port Data Role*/
	unsigned char port_data_role:1;
		/* Specification Revision*/
	unsigned char specification_revision:2;
		/* Port Power Role*/
	unsigned char port_power_role:1;
		/* MessageID*/
	unsigned char message_id:3;
		/* Number of Data Objects*/
	unsigned char number_of_data_objects:3;
		/* Extended*/
...
unsigned char SendBlock(unsigned char type, unsigned char *pData,
...
unsigned char send_ext_message(unsigned char type,
...
extern unsigned char pd_get_battery_cap_ref;
extern unsigned char pd_get_battery_status_ref;
...
unsigned int pd30_src_pwr_rules_ma(unsigned char watts,
