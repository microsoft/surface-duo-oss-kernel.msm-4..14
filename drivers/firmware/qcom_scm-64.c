...
int __qcom_scm_iommu_dump_fault_regs(u32 id, u32 context, u64 addr, u32 len)
{
	...
	desc.args[2] = addr;
	desc.args[3] = len;
	desc.arginfo = QCOM_SCM_ARGS(4, SCM_VAL, SCM_VAL, SCM_RW, SCM_VAL);
...
int __qcom_scm_iommu_secure_ptbl_init(u64 addr, u32 size, u32 spare)
{
	...
	desc.args[1] = size;
	desc.args[2] = spare;
	desc.arginfo = QCOM_SCM_ARGS(3, SCM_RW, SCM_VAL, SCM_VAL);
				...
				u32 flags)
{
	...
	desc.args[7] = flags;
	desc.arginfo = QCOM_SCM_ARGS(8, SCM_RW, SCM_VAL, SCM_VAL, SCM_VAL,
...
int __qcom_scm_is_call_available(u32 svc_id, u32 cmd_id)
{
	...
	ret = qcom_scm_call(SCM_SVC_INFO, IS_CALL_AVAIL_CMD, &desc);
	if (ret)
		return ret;
