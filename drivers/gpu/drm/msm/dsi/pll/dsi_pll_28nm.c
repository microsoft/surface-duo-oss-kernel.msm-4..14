		...
		unsigned long parent_rate)
{
	...
	if (frac_n_mode) {
		sdm_cfg0 = (0x0 << 6);
		sdm_cfg0 |= (0x0 & 0x3f);
		sdm_cfg1 |= (u32)(((div_fbx1000 / 1000) & 0x3f) - 1);
		sdm_cfg3 = frac_n_value >> 8;
		sdm_cfg2 = frac_n_value & 0xff;
	} else {
		sdm_cfg0 = (0x1 << 6);
		sdm_cfg0 |= (u32)(((div_fbx1000 / 1000) & 0x3f) - 1);
		sdm_cfg1 |= (0x0 & 0x3f);
		sdm_cfg2 = 0;
		sdm_cfg3 = 0;
	}
	...
	pll_write(base + REG_DSI_28nm_PHY_PLL_SDM_CFG1, sdm_cfg1 & 0x3f);
	pll_write(base + REG_DSI_28nm_PHY_PLL_SDM_CFG2, sdm_cfg2 & 0xff);
	pll_write(base + REG_DSI_28nm_PHY_PLL_SDM_CFG3, sdm_cfg3 & 0xff);
