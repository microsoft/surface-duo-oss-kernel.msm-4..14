...
static int msm_dmov_probe(struct platform_device *pdev)
{
	...
	dmov_conf[adm].irq = platform_get_irq(pdev, 0);
	if (dmov_conf[adm].irq < 0)
		return dmov_conf[adm].irq;
