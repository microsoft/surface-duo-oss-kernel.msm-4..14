...
#define HAL_TCL1_RING_TP_ADDR_LSB(ab)		ab->hw_params.regs->hal_tcl1_ring_tp_addr_lsb
#define HAL_TCL1_RING_TP_ADDR_MSB(ab)		ab->hw_params.regs->hal_tcl1_ring_tp_addr_msb
#define HAL_TCL1_RING_CONSUMER_INT_SETUP_IX0(ab) ab->hw_params.regs->hal_tcl1_ring_consumer_int_setup_ix0
#define HAL_TCL1_RING_CONSUMER_INT_SETUP_IX1(ab) ab->hw_params.regs->hal_tcl1_ring_consumer_int_setup_ix1
#define HAL_TCL1_RING_MSI1_BASE_LSB(ab)		ab->hw_params.regs->hal_tcl1_ring_msi1_base_lsb
#define HAL_TCL1_RING_MSI1_BASE_MSB(ab)		ab->hw_params.regs->hal_tcl1_ring_msi1_base_msb
#define HAL_TCL1_RING_MSI1_DATA(ab)		ab->hw_params.regs->hal_tcl1_ring_msi1_data
...
#define HAL_TCL_STATUS_RING_BASE_LSB(ab)   ab->hw_params.regs->hal_tcl_status_ring_base_lsb
...
#define HAL_REO1_RING_PRODUCER_INT_SETUP(ab)	ab->hw_params.regs->hal_reo1_ring_producer_int_setup
...
#define HAL_REO1_AGING_THRESH_IX_0(ab)		ab->hw_params.regs->hal_reo1_aging_thresh_ix_0
#define HAL_REO1_AGING_THRESH_IX_1(ab)		ab->hw_params.regs->hal_reo1_aging_thresh_ix_1
#define HAL_REO1_AGING_THRESH_IX_2(ab)		ab->hw_params.regs->hal_reo1_aging_thresh_ix_2
#define HAL_REO1_AGING_THRESH_IX_3(ab)		ab->hw_params.regs->hal_reo1_aging_thresh_ix_3
...
#define HAL_REO1_RING_MISC_OFFSET(ab) (HAL_REO1_RING_MISC(ab) - HAL_REO1_RING_BASE_LSB(ab))
...
#define HAL_REO_TCL_RING_BASE_LSB(ab)		ab->hw_params.regs->hal_reo_tcl_ring_base_lsb
...
/* REO status address */
#define HAL_REO_STATUS_RING_BASE_LSB(ab)	ab->hw_params.regs->hal_reo_status_ring_base_lsb
