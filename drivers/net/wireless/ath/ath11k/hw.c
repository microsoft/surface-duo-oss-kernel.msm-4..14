...
static int ath11k_mac_id_to_pdev_id_qca6390(int mac_id)
{
	return 0;
}

static int ath11k_mac_id_to_srng_id_qca6390(int mac_id)
{
	return mac_id;
}
...
const struct ath11k_hw_ops ipq8074_ops = {
	...
	.mac_id_to_pdev_id = ath11k_mac_id_to_pdev_id_qca6390,
	.mac_id_to_srng_id = ath11k_mac_id_to_srng_id_qca6390,
};
