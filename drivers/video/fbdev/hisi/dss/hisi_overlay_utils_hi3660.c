	...
	if (g_fpga_flag == 0) {
		if ((ovl_idx == DSS_OVL2) || (ovl_idx == DSS_OVL3) || (layer->chn_idx == DSS_RCHN_V2)) {
			if (layer && ((layer->need_cap & CAP_AFBCD) != CAP_AFBCD)) {
				...
				if (g_debug_ovl_online_composer || g_debug_ovl_credit_step) {
...
void hisi_dss_arsr2p_init(char __iomem * arsr2p_base, dss_arsr2p_t *s_arsr2p)
{
	...
	s_arsr2p->arsr2p_effect.skin_thres_y = inp32(arsr2p_base + ARSR2P_SKIN_THRES_Y);
	s_arsr2p->arsr2p_effect.skin_thres_u = inp32(arsr2p_base + ARSR2P_SKIN_THRES_U);
	s_arsr2p->arsr2p_effect.skin_thres_v = inp32(arsr2p_base + ARSR2P_SKIN_THRES_V);
	s_arsr2p->arsr2p_effect.skin_cfg0 = inp32(arsr2p_base + ARSR2P_SKIN_CFG0);
	s_arsr2p->arsr2p_effect.skin_cfg1 = inp32(arsr2p_base + ARSR2P_SKIN_CFG1);
	s_arsr2p->arsr2p_effect.skin_cfg2 = inp32(arsr2p_base + ARSR2P_SKIN_CFG2);
	s_arsr2p->arsr2p_effect.shoot_cfg1 = inp32(arsr2p_base + ARSR2P_SHOOT_CFG1);
	s_arsr2p->arsr2p_effect.shoot_cfg2 = inp32(arsr2p_base + ARSR2P_SHOOT_CFG2);
	s_arsr2p->arsr2p_effect.sharp_cfg1 = inp32(arsr2p_base + ARSR2P_SHARP_CFG1);
	s_arsr2p->arsr2p_effect.sharp_cfg2 = inp32(arsr2p_base + ARSR2P_SHARP_CFG2);
	s_arsr2p->arsr2p_effect.sharp_cfg3 = inp32(arsr2p_base + ARSR2P_SHARP_CFG3);
	s_arsr2p->arsr2p_effect.sharp_cfg4 = inp32(arsr2p_base + ARSR2P_SHARP_CFG4);
	s_arsr2p->arsr2p_effect.sharp_cfg5 = inp32(arsr2p_base + ARSR2P_SHARP_CFG5);
	s_arsr2p->arsr2p_effect.sharp_cfg6 = inp32(arsr2p_base + ARSR2P_SHARP_CFG6);
	s_arsr2p->arsr2p_effect.sharp_cfg7 = inp32(arsr2p_base + ARSR2P_SHARP_CFG7);
	s_arsr2p->arsr2p_effect.sharp_cfg8 = inp32(arsr2p_base + ARSR2P_SHARP_CFG8);
	s_arsr2p->arsr2p_effect.sharp_cfg9 = inp32(arsr2p_base + ARSR2P_SHARP_CFG9);
	s_arsr2p->arsr2p_effect.texturw_analysts = inp32(arsr2p_base + ARSR2P_TEXTURW_ANALYSTS);
	s_arsr2p->arsr2p_effect.intplshootctrl = inp32(arsr2p_base + ARSR2P_INTPLSHOOTCTRL);
...
void hisi_dss_arsr2p_coef_on(struct hisi_fb_data_type *hisifd, bool enable_cmdlist)
{
	...
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SKIN_THRES_Y, (75 | (83 << 8) | (145 << 16)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SKIN_THRES_U, (5 | (10 << 8) | (113 << 16)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SKIN_THRES_V, (6 | (12 << 8) | (152 << 16)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SKIN_CFG0, (512 | (3 <<12)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SKIN_CFG1, (819), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SKIN_CFG2, (682), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SHOOT_CFG1, (512 | (20 << 16)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SHOOT_CFG2, (-16 | (0 << 16)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SHARP_CFG1, (2 | (6 << 8) | (48 << 16) | (64 << 24)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SHARP_CFG2, (8 | (24 << 8) | (24 << 16) | (40 << 24)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SHARP_CFG3, (1 | (1 << 8) | (2500 << 16)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SHARP_CFG4, (10 | (6 << 8) | (9 << 16) | (12 << 24)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SHARP_CFG5, (2 | (12 << 8)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SHARP_CFG6, (448 | (64 << 16)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SHARP_CFG7, (1 | (250 << 16)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SHARP_CFG8, (-48000), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_SHARP_CFG9, (-32000), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_TEXTURW_ANALYSTS, (15 | (20 << 16)), 32, 0);
	hisifd->set_reg(hisifd, arsr2p_base + ARSR2P_INTPLSHOOTCTRL, (4), 32, 0);
