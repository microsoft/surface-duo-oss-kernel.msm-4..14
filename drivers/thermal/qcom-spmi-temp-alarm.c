...
static int __init qpnp_tm_driver_sync(void)
{
	complete(&qpnp_tm_driver_start);
	return 0;
}
device_initcall_sync(qpnp_tm_driver_sync);

static int __init qpnp_tm_driver_wait(void)
{
