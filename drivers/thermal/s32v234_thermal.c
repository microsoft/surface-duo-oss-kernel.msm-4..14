...
static void tmu_calibrate(struct device *dev)
{
	...
	int calibration_table[5][16] = {
		{  25, 30, 36, 42, 48, 54, 60, 66, 73,  80,  86, 93, -1, -1, -1,
			-1 },
		{  15, 22, 29, 36, 43, 51, 59, 67, 75,  83,  92, -1, -1, -1, -1,
			-1 },
		{  11, 19, 28, 37, 46, 56, 66, 76, 86,  -1,  -1, -1, -1, -1, -1,
			-1 },
		{   0,  9, 20, 30, 41, 53, 65, 77, 89, 102, 115, -1, -1, -1, -1,
			-1 },
		{ 104, 99, 93, 88, 82, 77, 72, 67, 62,  57,  53, 48, 44, 40, 35,
			-1 },
	};
