...
#define PAD_CTL_SRE_208MHZ	(0 << PAD_CTL_SRC_OFS)
#define PAD_CTL_SRE_150MHZ	(4 << PAD_CTL_SRC_OFS)
#define PAD_CTL_SRE_100MHZ	(5 << PAD_CTL_SRC_OFS)
#define PAD_CTL_SRE_50MHZ	(6 << PAD_CTL_SRC_OFS)
#define PAD_CTL_SRE_25MHZ	(7 << PAD_CTL_SRC_OFS)
